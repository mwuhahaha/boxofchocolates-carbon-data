...
Carbon-intensity data is provided by
[Electricity Maps](https://www.electricitymaps.com/) for the
`US-MIDA-PJM` grid region.

Electricity Maps publishes its open datasets under the
